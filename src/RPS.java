...
public class RPS {
    ...
    public static void main(String[] args){
        ...
        //If the initial string was valid, the current length of the string should only be one character
        if (string.length() > 1) {
            System.out.println("Invalid");  //Print invalid if the string length is more than 1
        }
        else {
            System.out.println("Valid");  //The string length is 1 and correct
        }
    }
}
